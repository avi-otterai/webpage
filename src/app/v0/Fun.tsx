  ...
  <Section>
    <div className="space-y-6 text-emerald-800">
      ...
      <ol className="list-decimal list-inside space-y-2">
        ...
        <li><strong>Sci-fi novel</strong>: DNA Revolution, a story of Venezuela embroilled in a politico-military crisis on the eve of a major breakthrough in genetics.</li>
