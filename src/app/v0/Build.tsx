...
const Build: React.FC = () => (
  <Section>
    ...
    <table className="mt-4">
      <tbody>
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/pinegapLogo.jpeg" alt="PineGap.ai" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/saras.png" alt="Saras edtech chatbot" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/ballpark.png" alt="Ballpark" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/survey.png" alt="Living Surveys" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/designAR.jpg" alt="DesignAR" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/election.png" alt="Election Guide Interactive" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/sutd.png" alt="SUTD" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/covid.png" alt="Covid" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/samsung.png" alt="Samsung" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/iitbhu.jpg" alt="Campus" style={{ width: '400px' }} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><img src="/static/contraption.jpeg" alt="Contraption" style={{ width: '400px' }} /></td>
