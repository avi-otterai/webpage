...
const Home: React.FC = () => (
  <Section>
    ...
    <table className="mt-4">
      <tbody>
        <tr className="mb-4">
          <td className="pr-4 pb-4"><Image src="/static/usc.jpeg" alt="USC" width={200} height={200} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><Image src="/static/msr.png" alt="MSR" width={200} height={200} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><Image src="/static/alexa.png" alt="Alexa" width={200} height={200} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><Image src="/static/ai2.png" alt="AI2" width={200} height={200} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><Image src="/static/neu.png" alt="NEU" width={200} height={200} /></td>
        ...
        <tr className="mb-4">
          <td className="pr-4 pb-4"><Image src="/static/sutd.png" alt="SUTD" width={200} height={200} /></td>
          <td className="pb-4">Singapore University of Technology and Design, Singapore. Mentor: Yuen Chau. Summer 2016.</td>
        </tr>
        <tr className="mb-4">
          <td className="pr-4 pb-4"><Image src="/static/iitbhu.jpg" alt="IIT BHU" width={200} height={200} /></td>
